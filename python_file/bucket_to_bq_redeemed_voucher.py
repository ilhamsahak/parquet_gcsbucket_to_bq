...
def get_config() -> dict[str, str]:
    ...
    target_table = get_required_env("REDEEMED_VOUCHER_TABLE_ID")
    gcs_uri = get_required_env("REDEEMED_VOUCHER_GCS_URI")
...
# Main execution flow
# ------------------------------------------------------------
def load_redeemed_voucher() -> None:
    config = get_config()
