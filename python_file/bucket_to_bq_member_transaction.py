...
def get_config() -> dict[str, str]:
    ...
    target_table = get_required_env("MEMBER_TRANSACTION_TABLE_ID")
    gcs_uri = get_required_env("MEMBER_TRANSACTION_GCS_URI")
...
# Main execution flow
# ------------------------------------------------------------
def load_member_transaction() -> None:
    config = get_config()
