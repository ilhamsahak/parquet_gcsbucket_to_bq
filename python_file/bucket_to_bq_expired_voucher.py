...
def get_config() -> dict[str, str]:
    ...
    target_table = get_required_env("EXPIRED_VOUCHER_TABLE_ID")
    gcs_uri = get_required_env("EXPIRED_VOUCHER_GCS_URI")
