...
def get_config() -> dict[str, str]:
    ...
    target_table = get_required_env("VOUCHER_EVENT_TYPE_TABLE_ID")
    gcs_uri = get_required_env("VOUCHER_EVENT_TYPE_GCS_URI")
...
# Main execution flow
# ------------------------------------------------------------
def load_voucher_event_type() -> None:
    config = get_config()
