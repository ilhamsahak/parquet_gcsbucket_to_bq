...
def get_config() -> dict[str, str]:
    ...
    target_table = get_required_env("PAYMENT_MODE_DETAILS_TABLE_ID")
    gcs_uri = get_required_env("PAYMENT_MODE_DETAILS_GCS_URI")
...
# Main execution flow
# ------------------------------------------------------------
def load_payment_mode_details() -> None:
    config = get_config()
