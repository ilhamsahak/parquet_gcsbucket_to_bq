...
def get_config() -> dict[str, str]:
    ...
    target_table = get_required_env("GROUP_USERS_DETAILS_TABLE_ID")
    gcs_uri = get_required_env("GROUP_USERS_DETAILS_GCS_URI")
...
# Main execution flow
# ------------------------------------------------------------
def load_group_users_details() -> None:
    config = get_config()
